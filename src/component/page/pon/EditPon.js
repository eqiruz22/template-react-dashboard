...
import { getOltSelect, getPonById } from '../../../request/http'
...
const EditPon = () => {
    ...
    useEffect(() => {
        getPonById(setPon, setFsp, setCapacity, setStatus, setAllocation, setOltId, setDesc, setSplitter, user)
    }, [user])
            ...
            <div id='content-wrapper' className='d-flex flex-column'>
                <div id='content'>
                    ...
                    <div className='container-fluid'>
                        <h1 className="h3 mb-0 text-gray-800">Edit PON</h1>
